...
Class game Extends App
	...
	Method OnRender:Int()
		...
		'DrawText("FPS:"+eng.GetFPS(),20,10)
		DrawText("Width:"+DeviceWidth()+"   "+eng.scaleX,20,10)
		DrawText("Tile unter mouse at "+x+":"+y+" = "+tileMap.GetTileIDAt(x,y),310,10)
		Return 0
	End
	'------------------------------------------
	Method OnResume:Int()
